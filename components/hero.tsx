      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-8 md:px-12 lg:px-12 lg:pl-16 pt-20 sm:pt-24 md:pt-28 lg:pt-24 pb-2 sm:pb-4 md:pb-6 lg:pb-0 bg-[#0B0F14]">
        <div className="max-w-2xl">
          ...
          <motion.button
            ...
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-[#8B8CF6] hover:bg-[#A5B4FC] text-[#0B0F14] font-semibold rounded-lg transition-colors duration-300 text-lg mb-8 sm:mb-12"
          >
            Let's talk
          </motion.button>
          <motion.div
